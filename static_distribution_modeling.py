from fancy_distributions import Multimodal_MultivariateNormal, Multimodal_Normal
from fitting_tools import Fitting_nnModule, MLP_res_net, Norm, get_nuy_and_auto_norm
...
class Dependent_dist(Fitting_nnModule):
    def __init__(self, nz, ny, norm: Norm = Norm(), n_weights=10, \
        ...
        super(Dependent_dist, self).__init__()
        self.norm = norm
...
if __name__=='__main__' and False:
    ...
    model = Dependent_dist(*get_nuy_and_auto_norm(*train),n_weights=n_weights,\
